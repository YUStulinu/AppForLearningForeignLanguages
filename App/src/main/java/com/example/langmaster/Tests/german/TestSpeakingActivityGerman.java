...
public class TestSpeakingActivityGerman extends ComponentActivity {
    ...
    private TextView textViewGermanWord;
    private TextView textViewGermanResult;
    private Button buttonGermanNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_speaking_german);

        textViewGermanWord = findViewById(R.id.text_view_wort);
        textViewGermanResult = findViewById(R.id.text_view_ergebnis);
        buttonGermanNext = findViewById(R.id.button_nächste);
        ...
        Button startButton = findViewById(R.id.button_test_starten);
        ...
        buttonGermanNext.setOnClickListener(v -> {
            // Trecem la următorul cuvânt
            if (currentWordIndex < wordList.size() - 1) {
                currentWordIndex++;
                textViewGermanWord.setText(wordList.get(currentWordIndex));
                textViewGermanResult.setText("");
            } else {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle results) {
                ...
                if (matches != null && !matches.isEmpty()) {
                    ...
                    textViewGermanResult.setText("Pronunție corectă: " + correctPercentage + "%");
                }
            }
