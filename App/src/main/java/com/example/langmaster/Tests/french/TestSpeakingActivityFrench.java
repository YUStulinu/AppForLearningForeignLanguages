...
public class TestSpeakingActivityFrench extends ComponentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_speaking_french);

        textViewMot = findViewById(R.id.text_view_mot);
        ...
        Button startButton = findViewById(R.id.button_test_commence);
        ...
        buttonSuivant.setOnClickListener(v -> {
            ...
            if (currentWordIndex < wordList.size() - 1) {
                currentWordIndex++;
                textViewMot.setText(wordList.get(currentWordIndex));
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle results) {
                ...
                if (matches != null && !matches.isEmpty()) {
                    ...
                    textViewResultat.setText("Pronunție corectă: " + correctPercentage + "%");
                }
            }
