...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.begin_button;
      Button beginButton = ViewBindings.findChildViewById(rootView, id);
      if (beginButton == null) {
        break missingId;
      }

      return new ActivityMainBinding((RelativeLayout) rootView, appTitle, beginButton);
    }
